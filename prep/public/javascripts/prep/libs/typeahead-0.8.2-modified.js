 ...
 *
 * Modified by pkat - added jqXHR.setRequestHeader
 */
                ...
                if (resp = this.cache.get(url)) {
                    ...
                    $.ajax({
                        ...
                        beforeSend: function(jqXHR) {
                            ...
                            jqXHR.setRequestHeader('X-CSRF-Token', window.Conf.csrf_token);
                        },
                        success: function(resp) {
                            cb && cb(resp);
                            angular.element(document.querySelector('[ng-app]')).injector().get('responseInterceptor').successInterceptor(resp);
                            that.cache.set(url, resp);
                        },
                        error: function(resp) {
                            angular.element(document.querySelector('[ng-app]')).injector().get('responseInterceptor').errorInterceptor(resp);
                        },
                        complete: function() {
