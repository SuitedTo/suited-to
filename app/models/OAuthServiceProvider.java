 ...
 */
@Entity
public class OAuthServiceProvider extends ModelBase {
	...
	/**
	 * Instantiates a new o auth service provider.
	 *
	 * @param requestTokenURL the request token url
	 * @param userAuthorizationURL the user authorization url
	...
	public int hashCode() {
		...
		result = prime
				* result
				+ ((userAuthorizationURL == null) ? 0 : userAuthorizationURL
						.hashCode());
		return result;
	}
