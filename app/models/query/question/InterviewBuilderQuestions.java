...
/**
 * Query for questions that the interview builder is allowed to access
 *
 * @author joel
 */
public class InterviewBuilderQuestions extends QuestionQuery {
	protected User user;

	public InterviewBuilderQuestions() {
		super();
		this.user = Security.connectedUser();
	}

	public InterviewBuilderQuestions(User user, Integer iSortCol_0, String sSortDir_0, String sSearch,
