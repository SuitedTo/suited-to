 ...
 */
@Entity
public class OAuthAccessor extends ModelBase implements Cloneable, Serializable {
    ...
    /**
     * User associated with this OAuthAccessor
     */
    @ManyToOne
    public User user;
	 ...
	 * @throws net.oauth.OAuthException the o auth exception
