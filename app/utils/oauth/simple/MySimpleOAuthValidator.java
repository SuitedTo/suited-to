...
import play.Logger;
import utils.oauth.MyOAuthValidator;
...
/**
 * The Class MySimpleOAuthValidator.
 */
public class MySimpleOAuthValidator implements MyOAuthValidator {
     ...
     *            the max version
     */
    public MySimpleOAuthValidator(long maxTimestampAgeMsec,
                                      double maxVersion) {
