...
public class RSA_SHA1 extends OAuthSignatureMethod {
	...
	/* (non-Javadoc)
	 * @see net.oauth.signature.OAuthSignatureMethod#initialize(java.lang.String, models.OAuthAccessor)
	 */
	@Override
	...
	/**
	 * Gets the public key from der cert.
	 *
	 * @param certObject the cert object
	 * @return the public key from der cert
	...
	/**
	 * Gets the public key from der.
	 *
	 * @param publicKeyObject the public key object
	 * @return the public key from der
	 * @throws GeneralSecurityException the general security exception
	 */
	...
	/**
	 * Gets the private key from der.
	 *
	 * @param privateKeyObject the private key object
	 * @return the private key from der
	 * @throws GeneralSecurityException the general security exception
	 */
	...
	/**
	 * Gets the private key from pem.
	 *
	 * @param pem the pem
	 * @return the private key from pem
	 * @throws GeneralSecurityException the general security exception
	 * @throws IOException Signals that an I/O exception has occurred.
	 */
