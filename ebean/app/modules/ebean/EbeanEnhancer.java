...
public class EbeanEnhancer extends Enhancer
{
  ...
  public void enhanceThisClass(ApplicationClass applicationClass) throws Exception
  {
    ...
    if (!ctClass.subtypeOf(classPool.get("modules.ebean.EbeanSupport"))) {
    ...
    // create     
    ctClass.addMethod(CtMethod.make("public static modules.ebean.EbeanSupport create(String name, play.mvc.Scope.Params params) { return create(" + entityName + ".class,name, params.all(), null); }",ctClass));
    ...
    // findById
    ctClass.addMethod(CtMethod.make("public static modules.ebean.EbeanSupport findById(Object id) { return (" + entityName + ") ebean().find(" + entityName + ".class, id); }", ctClass));

    // findUnique
    ctClass.addMethod(CtMethod.make("public static modules.ebean.EbeanSupport findUnique(String query, Object[] params) { return (" + entityName + ") createQuery(" + entityName + ".class,query,params).findUnique(); }", ctClass));
